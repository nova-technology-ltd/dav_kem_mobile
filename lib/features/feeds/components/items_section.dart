...
import 'package:dav_kem/features/feeds/components/item_card_style.dart';
...
class ItemsSection extends StatefulWidget {
  ...
  const ItemsSection({super.key, required this.title, required this.subMessage});
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => SeeAllScreen(title: widget.title,)));
                },
                child: Container(
        ...
        SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                for (int i = 0; i < 7; i++)
                  ItemCardStyle(images: demoFoods[Random().nextInt(demoFoods.length)])
              ],
            ),
          ),
        ),
